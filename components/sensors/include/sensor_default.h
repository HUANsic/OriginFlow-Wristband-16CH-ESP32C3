 ...
 */
#ifndef _H_SENSOR_DEFAULTS_H_
#define _H_SENSOR_DEFAULTS_H_

#include "sensor_ctrl_if.h"
#include "sensor_data_if.h"
 ...
 */
sensor_gpio_if_t *sensor_new_gpio(void);
 ...
 */
sensor_data_if_t *sensor_new_i2s_data(sensor_i2s_cfg_t *i2s_cfg);
