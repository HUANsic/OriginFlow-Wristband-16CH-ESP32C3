...
static int _i2c_ctrl_open(const sensor_ctrl_if_t *ctrl, void *cfg, int cfg_size) {
  if (ctrl == NULL || cfg == NULL || cfg_size != sizeof(sensor_i2c_cfg_t)) {
    return SENSOR_INVALID_ARG;
  }
  i2c_ctrl_t *i2c_ctrl = (i2c_ctrl_t *) ctrl;
  sensor_i2c_cfg_t *i2c_cfg = (sensor_i2c_cfg_t *) cfg;
  ...
  return (ret == ESP_OK) ? 0 : SENSOR_DRV_ERR;
#else
  return 0;
#endif
}

static bool _i2c_ctrl_is_open(const sensor_ctrl_if_t *ctrl) {
  if (ctrl) {
    i2c_ctrl_t *i2c_ctrl = (i2c_ctrl_t *) ctrl;
...
static int _i2c_master_write_reg(i2c_ctrl_t *i2c_ctrl, int addr, int addr_len, void *data, int data_len) {
  ...
  return ret ? SENSOR_WRITE_FAIL : SENSOR_OK;
}
#endif

static int _i2c_ctrl_read_reg(const sensor_ctrl_if_t *ctrl, int addr, int addr_len, void *data, int data_len) {
...
static int _i2c_ctrl_write_reg(const sensor_ctrl_if_t *ctrl, int addr, int addr_len, void *data, int data_len) {
  i2c_ctrl_t *i2c_ctrl = (i2c_ctrl_t *) ctrl;
  if (ctrl == NULL || data == NULL) {
    return SENSOR_INVALID_ARG;
  }
...
static int _i2c_ctrl_close(const sensor_ctrl_if_t *ctrl) {
  if (ctrl == NULL) {
    return SENSOR_INVALID_ARG;
  }
  i2c_ctrl_t *i2c_ctrl = (i2c_ctrl_t *) ctrl;
...
sensor_ctrl_if_t *sensor_new_i2c_ctrl(sensor_i2c_cfg_t *i2c_cfg) {
  if (i2c_cfg == NULL) {
  ...
  int ret = _i2c_ctrl_open(&ctrl->base, i2c_cfg, sizeof(sensor_i2c_cfg_t));
  if (ret != 0) {
    free(ctrl);
    return NULL;
  }
